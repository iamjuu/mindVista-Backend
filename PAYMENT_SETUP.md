...
### 2. API Endpoints
Frontend calls backend at: `https://mind-vista-backend.vercel.app/api/` (or `http://localhost:3000/api/` for local dev)
...
3. **Currency**: INR only
4. **CORS**: Backend configured to allow requests from `https://mind-vista-psychology-web-app-dvb3.vercel.app` (or `http://localhost:5173` for local dev)
